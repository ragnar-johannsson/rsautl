...
function operation (name, data, key, callback, options) {
    var options = options || {};
...
exports.encrypt = function encrypt (data, key, callback, options) { operation('encrypt', data, key, callback, options); };
exports.decrypt = function decrypt (data, key, callback, options) { operation('decrypt', data, key, callback, options); };
exports.sign = function sign (data, key, callback, options) { operation('sign', data, key, callback, options); };
exports.verify = function verify (data, key, callback, options) { operation('verify', data, key, callback, options); };
